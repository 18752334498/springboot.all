...
public class OperatorTest {
     ...
     *
     *
     * ExponentialBackoffRetry：重试一定次数，每次重试时间依次递增 RetryNTimes：重试N次 RetryOneTime：重试一次
    ...
    public void testSessionTimeout() throws Exception {
        ...
        // SESSION_TIMEOUT = 10000毫秒，10秒之后消失
        // 创建临时节点
        client.create().withMode(CreateMode.EPHEMERAL).forPath("/curator", "/curator/ephemeral data".getBytes());
